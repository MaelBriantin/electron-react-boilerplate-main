...
import animeServices from '../renderer/services/animeServices';
...
describe('Anime Services', () => {
  it('should return AnimeType from API successfully', async () => {
    ...
    //    sera appelé dans ce test il répondra par une fausse réponse
